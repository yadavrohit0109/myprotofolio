      ...
      <div className="relative max-w-screen-2xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between">
        ...
        <div className="relative z-[110] flex items-center gap-3">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="text-sm md:text-base px-5 py-2 bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 
          ...
          <div className="hidden md:flex gap-8 ml-10">
            {["Home", "About", "Projects", "Reviews"].map((item, index) => (
              <motion.a
                ...
                href={`#${item.toLowerCase()}`}
                whileHover={{ scale: 1.1 }}
                className="relative text-white text-lg font-medium tracking-wide hover:text-indigo-400 transition-all group"
              >
                {item}
