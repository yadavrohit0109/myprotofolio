  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-500 text-transparent bg-clip-text mb-6 text-center"
      >
        What People Say About My Work 💬
      </motion.h2>

      <p className="text-gray-300 text-lg max-w-3xl mx-auto mb-12 leading-relaxed text-center">
        Testimonials from clients and professionals who experienced my
        ...
        {reviews.map(({ content, name, company, imgSrc, href, isInstagram }, i) => (
          ...
          >
            ...
            <a
              ...
              aria-label={`Connect with ${name} on ${
